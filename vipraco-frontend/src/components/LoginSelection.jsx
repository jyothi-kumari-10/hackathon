  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", minHeight: "100vh", background: "#f4f8fb", padding: 0 }}>
      ...
      <p style={{ fontSize: 18, color: "#333", margin: "12px 0 32px 0", maxWidth: 600, textAlign: "center" }}>
        Your smart HR assistant for seamless employee support, leave management, payroll, and company policies. Empowering organizations and employees to thrive together.
      </p>
      <div style={{ display: "flex", gap: 60, background: "#fff", padding: 40, borderRadius: 16, boxShadow: "0 2px 16px #0001", marginBottom: 40 }}>
        <div style={{ minWidth: 350, textAlign: "center" }}>
          ...
          <h2 style={{ fontWeight: 700, fontSize: 26, margin: 0 }}>For Organizations</h2>
          ...
          <div style={{ marginTop: 16, fontSize: 15 }}>
            Don&apos;t have an account? <span style={{ color: "#2e8b57", fontWeight: 600 }}>Contact sales</span> or <span style={{ color: "#2e8b57", fontWeight: 600 }}>Get free trial</span>
          </div>
        </div>
        <div style={{ minWidth: 350, textAlign: "center" }}>
          <div style={{ marginBottom: 16 }}>
          ...
          <div style={{ marginTop: 16, fontSize: 15 }}>
            Don&apos;t have an account? <span style={{ color: "#2e8b57", fontWeight: 600 }}>Sign up.</span>
          </div>
        </div>
      </div>
    </div>
