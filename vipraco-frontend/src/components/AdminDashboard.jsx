  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f4f8fb", padding: "40px 0" }}>
      <div style={{ maxWidth: 600, margin: "40px auto", padding: 32, border: "none", borderRadius: 16, background: "#fff", boxShadow: "0 2px 16px #0001" }}>
        <h2 style={{ textAlign: "center", fontWeight: 800, fontSize: 32, color: "#1a237e", marginBottom: 24 }}>Admin Dashboard</h2>
        ...
        <div style={{ marginBottom: 32 }}>
          ...
          <div style={{ display: "flex", gap: 10, marginBottom: 10 }}>
            ...
            <button onClick={handleRemoveOrg} style={{ background: "#e53935", color: "#fff", border: "none", borderRadius: 6, padding: "8px 18px", fontWeight: 600, cursor: "pointer" }}>Remove</button>
          </div>
        </div>
        <div style={{ marginBottom: 32 }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 10, marginBottom: 10 }}>
            ...
            <input placeholder="Password" value={empData.password} onChange={e => setEmpData({ ...empData, password: e.target.value })} style={{ flex: 1, padding: 8, borderRadius: 6, border: "1px solid #bbb" }} />
            ...
            <input placeholder="Date of Joining (YYYY-MM-DD)" value={empData.date_of_joining} onChange={e => setEmpData({ ...empData, date_of_joining: e.target.value })} style={{ flex: 1, padding: 8, borderRadius: 6, border: "1px solid #bbb" }} />
            ...
            <button onClick={handleAddEmp} style={{ background: "#00bcd4", color: "#fff", border: "none", borderRadius: 6, padding: "8px 18px", fontWeight: 600, cursor: "pointer" }}>Add</button>
          </div>
        </div>
        <div style={{ marginBottom: 32 }}>
